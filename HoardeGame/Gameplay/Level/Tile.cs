...
namespace HoardeGame.Gameplay.Level
{
    ...
    public class Tile : Graphics.IDrawable
    {
        ...
        public Tile(GameServiceContainer serviceContainer, Vector2 pos, Vector2 scale, Texture2D texture, bool collide, DungeonLevel level, int type)
        {
            Scale = scale;
        ...
        public void Draw(EffectParameter parameter)
        {
