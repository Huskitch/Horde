...
namespace HoardeGame.Entities.Drops
{
    ...
    public class EntityGem3 : EntityBase
    {
        ...
        public EntityGem3(DungeonLevel level, GameServiceContainer serviceContainer) : base(level, serviceContainer)
        {
            ...
            animator = new AnimatedSprite(resourceProvider.GetTexture("EmeraldSheet"), serviceContainer);
